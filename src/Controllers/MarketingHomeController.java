 ...
 * @author dainer
 */
public class MarketingHomeController implements Initializable {
    ...
    @FXML
    private void overviewClicked() throws IOException {
        try {
            rootPane.getChildren().clear();
            rootPane.setOpacity(0);
            new FadeInTransition(rootPane).play();
            AnchorPane pane = FXMLLoader.load(getClass().getResource(nav.getOverViewMarketing()));
            rootPane.getChildren().setAll(pane);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    @FXML
    private void newsletterClick(ActionEvent event) throws IOException {
        try {
            rootPane.getChildren().clear();
            rootPane.setOpacity(0);
            new FadeInTransition(rootPane).play();
            AnchorPane pane = FXMLLoader.load(getClass().getResource(nav.getNewsletter()));
            rootPane.getChildren().setAll(pane);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    @FXML
    private void mtiClick(ActionEvent event) throws IOException {
        try {
            rootPane.getChildren().clear();
            rootPane.setOpacity(0);
            new FadeInTransition(rootPane).play();
            AnchorPane pane = FXMLLoader.load(getClass().getResource(nav.getMarketingTargetIndividual()));
            rootPane.getChildren().setAll(pane);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void statClick(ActionEvent event) throws IOException {
        try {
            ...
            rootPane.setOpacity(0);
            new FadeInTransition(rootPane).play();
            AnchorPane pane = FXMLLoader.load(getClass().getResource(nav.getMarketingStats()));
            rootPane.getChildren().setAll(pane);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    @FXML
    private void promotionClick(ActionEvent event) throws IOException {
        try {
            rootPane.getChildren().clear();
            rootPane.setOpacity(0);
            new FadeInTransition(rootPane).play();
            AnchorPane pane = FXMLLoader.load(getClass().getResource(nav.getPromotion()));
            rootPane.getChildren().setAll(pane);
        } catch (Exception e) {
            System.out.println(e);
        }
    ...
    private void setValueModel() {
        emailUser.setText("dainerxx.21@gmail.com");
        Username.setText("Dainer");
        levelUser.setText("Marketing Manager");
        setMenu();
    }
